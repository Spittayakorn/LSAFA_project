...
?>
	...
	<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
		<tr>
			<td colspan='3'><a href='Smain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > นักศึกษา</a> > จัดการข้อมูลส่วนตัว</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
	...
	<form name='addMember' id='addMember' action='SEditQueryMem.php' method='POST' onsubmit='Javascript:return chkData()'>
