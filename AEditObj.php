...
<html>
<head>
	<title>แก้ไขประเภทวัตถุประสงค์</title>
	<meta charset='UTF-8'>
...
<body>
	...
	<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
		<td colspan='3'><a href='Amain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > เจ้าหน้าที่ห้องปฏิบัติการ</a> > <a href='AManageObj.php'>จัดการรายการประเภทวัตถุประสงค์</a> > แก้ไขวัตถุประสงค์</td>
		...
		<tr>
			<td>
				<div align='center'>
					<h2>แก้ไขประเภทวัตถุประสงค์</h2>
				</div>

	
	<form name='analysis' action='AEditQueryObj.php' method='POST' onsubmit='Javascript:return chkdata()'>
...
?>
			...
			<tr>
				...
				<td colspan='2'>
					...
					<input type='submit' value='แก้ไขประเภทวัตถุประสงค์'>
				</td>
			</tr>
		</table>
	</form>
