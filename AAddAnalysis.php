...
<body>
	...
	<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
		<tr>
			<td colspan='3'><a href='Amain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > เจ้าหน้าที่ห้องปฏิบัติการ</a> > <a href='AManageAnalysis.php'>จัดการรายการค่าวิเคราะห์</a> > เพิ่มรายการค่าวิเคราะห์</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
	...
	<form name='analysis' action='AAddFormAnalysis.php' method='POST' onsubmit='Javascript:return chkdata()'>
		...
		<br><input type='submit' value='เพิ่มค่าวิเคราะห์'>
	</form>
