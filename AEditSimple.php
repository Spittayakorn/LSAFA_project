...
<style>
	...
	<script>
		...
		function chkdata()
		{
			...
			{
				alert('กรุณากรอกชื่อชนิดตัวอย่าง');
				$('#anaName').focus();
			}
...
<body>
	...
	<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
		<tr>
			<td colspan='3'><a href='Amain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > เจ้าหน้าที่ห้องปฏิบัติการ</a> > <a href='AManageSimple.php'>จัดการรายการชนิดตัวอย่าง</a> > แก้ไขชนิดตัวอย่าง</td>
		...
		<tr>
			<td>
				<div align='center'>
					<h2>แก้ไขรายการชนิดตัวอย่าง</h2>
				</div>

	
	<form name='analysis' action='AEditQuerySim.php' method='POST' onsubmit='Javascript:return chkdata()'>
...
?>
			...
			<tr>
				...
				<td colspan='2'>
					...
					<input type='submit' value='แก้ไขชนิดตัวอย่าง'>
				</td>
			</tr>
		</table>
	</form>
