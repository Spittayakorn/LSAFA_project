...
<body>
	...
	<?php
		...
		{
			echo "<div align='right'>เลขที่ ".(int)$recnumSearchLab[2].".$recnumSearchLab[3]</div>";
		}
...
<!-- -->
									...
									$totoalBeforeAndAfter = $sumTotalAnaBefore+$sumTotalAnaAfter;
										...
										echo "<tr><td colspan='2'><b>ค่าใช้จ่ายรวมคิดเป็นเงินทั้งสิ้น&nbsp;&nbsp;<u>".number_format($totoalBeforeAndAfter)."</u>&nbsp;&nbsp;บาท</b></tr></td>";
									?>
	...
	<?php 
		...
		echo "<tr>
					...
					<td></td>
					<td></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ลงชื่อ&nbsp;&nbsp;".$memberLab."&nbsp;&nbsp;ผู้ขอใช้</td>
				</tr>";
