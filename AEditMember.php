...
?>
	...
	<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
		<tr>
			<td colspan='3'><a href='Amain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > เจ้าหน้าที่ห้องปฏิบัติการ</a> > <a href='AManageMember.php'>จัดการสมาชิก</a> > แก้ไขสมาชิก</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
	...
	<form name='addMember' id='addMember' action='AEditQueryMem.php' method='POST' onsubmit='Javascript:return chkData()'>
		<table border='0' id='myTable' cellpadding='10' align='center'>			
			<tr>
				<td>กลุ่มผู้ใช้งาน</td>
				<td>
					<input type='radio' name='level' value='1' 
					<?php if($recnumSearchMem[3]=='1') echo "checked";?>>นักศึกษา
					<input type='radio' name='level' value='2'
					<?php if($recnumSearchMem[3]=='2') echo "checked";?>>อาจารย์
					<input type='radio' name='level' value='3'
					<?php if($recnumSearchMem[3]=='3') echo "checked";?>>เจ้าหน้าที่
					<input type='radio' name='level' value='4'
					<?php if($recnumSearchMem[3]=='4') echo "checked";?>>ผู้บริหาร
				</td>
			</tr>
...
?>
			...
			<tr>
				<td>รหัสบัญชี</td>
				<td>
					<input type='text' name='username' id='username' value=<?php echo $recnumSearchMem[1]; ?>>
				</td>
			</tr>
...
<!--- ส่วนของเบอร์ -->
		...
		<input type='submit' id='submit' value='แก้ไขสมาชิก'>&nbsp;
	</form>
			</td>
		</tr>
	</table>
