<?php
	...
	if(trim($AmemName) == '' || trim($Aemail) == '' || trim($Apassmail) == '')
	{
		...
		echo "<script>
				...
				window.open('TEditMember.php?memCode=$memCode','_self')
			</script>";
	...
	if($offStatus =='2')
	{
		...
		$updateStatueTeacher = "update lab set teaCm='$offCM',teaStatus='$offStatus',offCode='$boCode',labStatus='1' where labCode='$labCode';";
		...
		foreach($arrayMail as $mailCode)
		{
			...
			if($email_receiver)
			{
				...
				echo "<script>
						...
						window.open('TManageLab.php?statusLab=$statusLab&pageNo=$pageNo','_self');
					</script>";
				}
	...
	if($offStatus =='1')
	{
		$updateSetTeacher = "update lab set offCode='$boCode' where labCode='$labCode';";
		...
		$updateStatusTeacher = "update lab set teaCm='$offCM',teaStatus='$offStatus',labStatus='0',send='1' where labCode='$labCode';";
