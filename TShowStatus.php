	...
	<body>
		...
		<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
			...
			<?php
				...
				echo "<tr>
						<td colspan='3'><a href='Tmain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > อาจารย์</a> > <a href='TManageLab.php?statusLab=$statusLab&pageNo=$pageNo'>เอกสารขอใช้ห้องปฏิบัติการจากนักศึกษา</a> > ตรวจสอบสถานะขอใช้ห้องปฏิบัติการ</td>
					</tr>";
			?>
