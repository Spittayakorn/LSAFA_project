...
?>
	...
	<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
		<tr>
			<td colspan='3'><a href='Hmain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > ผู้บริหารภาควิชา</a> > จัดการข้อมูลส่วนตัว</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
	...
	<form name='addMember' id='addMember' action='HEditQueryMem.php' method='POST' onsubmit='Javascript:return chkData()'>
