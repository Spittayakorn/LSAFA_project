...
<body>
	...
	<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
		<tr>
			<td colspan='3'><a href='Amain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > เจ้าหน้าที่ห้องปฏิบัติการ</a> > <a href='AManageAnalysis.php'>จัดการรายการค่าวิเคราะห์</a> > แก้ไขรายการค่าวิเคราะห์ </td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td>
				<div align='center'>
					<h2>แก้ไขรายการค่าวิเคราะห์</h2>
				</div>

	
	<form name='analysis' action='AEditQueryAna.php' method='POST' onsubmit='Javascript:return chkdata()'>
...
<?php 
	...
	$sqlSearchAna = "select * from analysislist where anaCode='$anaCode';";
...
?>
			...
			<tr>
				...
				<td colspan='2'>
					...
					<input type='submit' value='แก้ไขค่าวิเคราะห์'>
				</td>
			</tr>
		</table>
	</form>
