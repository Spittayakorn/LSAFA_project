	...
	<body>
		...
		<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
			...
			<?php
				...
				echo "<tr>
						<td colspan='3'><a href='Amain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > เจ้าหน้าที่ห้องปฏิบัติการ</a> > <a href='AGetLabH.php?statusLab=$statusLab&labStatus=$labStatus&pageNo=$pageNo '>เอกสารที่อนุมัติขอใช้ห้องปฏิบัติการจากผู้บริหาร</a> > ตรวจสอบข้อมูล</td>
					</tr>";
			?>
			<tr>
				<td>&nbsp;</td>
