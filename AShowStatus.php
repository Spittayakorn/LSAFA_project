...
<html>
	...
	<body>
		...
		<table id='myTables' width='100%' cellspacing='10' cellpadding='5'>
			<tr>
				<td colspan='3'><a href='Amain.php'> ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > เจ้าหน้าที่ห้องปฏิบัติการ</a> > <a href='AManageLab.php'>รายการแบบฟอร์มขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์</a> > ตรวจสอบสถานะ</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			</tr>
			...
			<tr>
				<td>
					...
					<table border='0' width='100%' cellpadding='10'>
						...
						<?php
							$chkTeacher='false';
							if($recnumSearchLab[14]=='0' && $recnumSearchLab[15]=='1')
							{
								$chkTeacher = 'true';
							}
							...
							if($recnumSearchLab[25]=='1')
							{
								...
								if($recnumSearchLab[14]=='0' || $chkTeacher=='true')
								{
									if($chkTeacher=='true')
									{
										...
										<td colspan='2'>
											<table id='tbSim' border='1' width='100%' cellpadding='5'>
												<tr>
													...
													<th width='25%'>ค่าที่ต้องการวิเคราะห์</th>
													<th width='30%'>ชนิดตัวอย่าง</th>
													<th width='20%'>คำนวณ</th>
													<th width='18%'>จำนวนตัวอย่าง (ซ้ำ)</th>
												</tr>
												<?php
													...
													while($recnumSearchAna = mysqli_fetch_array($resultSearchAna))
													{
														...
														{
															$j++;
															$getChargePrice = getCharge($recnumSearchAna[0],$resultSearchCat[0]);
															
															$anaVal = $getSumSim*$recnumSearchLab[10]*$getChargePrice;
															...
															echo "<tr>
																	...
																	<td>&nbsp;".$getSimName."</td>
																	<td align='center'>".number_format($getSumSim)." x ".$recnumSearchLab[10]." x ".number_format($getChargePrice)."</td>
												...
												<?php 
													...
													if($recnumSearchLab[14]=='0' && $recnumSearchLab[15]=='1')
													{
														echo "<tr>
																...
																<td colspan='2'>ลงชื่อ&nbsp;&nbsp;".$recnumSearchLab[5]."&nbsp;&nbsp;ผู้ขอใช้</td>
															</tr>";
