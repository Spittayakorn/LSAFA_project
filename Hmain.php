...
<body>
	...
	<table id='myTable' width='100%' cellspacing='10' cellpadding='5'>
		<tr>
			<td colspan='3'>ระบบขอใช้ห้องปฏิบัติการวิเคราะห์อาหารสัตว์ > ผู้บริหารภาควิชา</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		</tr>
			...
			<td>
				<table id='fixTB' align='center' cellpadding='20' border='1'>
					...
					<tr valign='top'>		
						<td height='200'>
							<ul>
								<a href="HManageLab.php?statusLab=0">
									<li style='margin-bottom:10px'>
										เอกสารขอใช้ห้องปฏิบัติการจากเจ้าหน้าที่ห้องปฏิบัติการ
									</li>
								</a>
							</ul>
							<ul>
								...
								echo '<a href="HExpenseReport.php?sDate=1998-01-01&lDate='.date("Y-m-d").'&typeG=line">';
								?>
									<li style='margin-bottom:10px'>
										รายงานค่าใช้จ่าย
									</li>
